...
-- Таблицы в той же схеме wvs, что users и events.
--
...
CREATE TABLE IF NOT EXISTS wvs.gen_sample (
    "D_INTERVIEW" BIGINT,
...
CREATE INDEX IF NOT EXISTS idx_gen_sample_country ON wvs.gen_sample ("B_COUNTRY_ALPHA");
CREATE INDEX IF NOT EXISTS idx_gen_sample_age ON wvs.gen_sample ("Q262");

CREATE TABLE IF NOT EXISTS wvs.country_data (
...
CREATE INDEX IF NOT EXISTS idx_country_data_code ON wvs.country_data (country_code);
